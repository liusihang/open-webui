...
db_user='webui_pr7'
database='webui_pr7'
expected_current_image_id='sha256:a1f90018c256b603644c51c82a15b8018d632246c55511206e68f442c83a7d39'
expected_formal_image_id='sha256:ab6d8f1816a40750a98bdcb18e5a7bd419869c43825a66631acc7f718e6f469b'
base_image='open-webui:v011-hotfix-93032060d9d5'
hotpatch_image='open-webui:v011-hotfix-e3a9c97dd059'
source_commit='e3a9c97dd059aa814ea4d34bf1aca910923cf2e8'
target_revision='a11c0d3f0bd0'
artifact='/tmp/openwebui-v011-hotfix-e3a9c97dd059-context.tar.gz'
expected_artifact_sha256='07f0418cb3ad3b37390c0fb3bc7edd71ef99625073cde2c26237c409a368f796'
deployment_root='/home/aiserver/staging/openwebui-pr7-eea11194ed-test'
context_dir="${deployment_root}/hotpatch-v011-e3a9c97dd059"
overlay="${deployment_root}/compose.webui-v011-hotfix-e3a9c97dd059.yaml"
backup_dir="${deployment_root}/backups/pre-hotpatch-e3a9c97dd059"
...
docker build \
    ...
    --file "${context_dir}/Dockerfile.hotpatch-e3a9c97dd059" \
    --tag "${hotpatch_image}" \
    "${context_dir}"
...
[[ "${image_scope}" == 'v0.11-mode-draft-isolation' ]]
...
docker exec "${target_container}" sh -eu -c \
    "test -s /app/build/index.html && test -s /app/build/_app/version.json && grep -R -F -q 'const type = event?.data?.type ?? null;' /app/build/_app/immutable && grep -R -F -q 'getConversationModeDraftCapabilitySnapshotForMode' /app/build/_app/immutable"
