...
db_user='webui_pr7'
database='webui_pr7'
expected_current_image_id='sha256:5a541612b86655ac1423b5e88109c47ff818819d99315cf7e51fa9a764e9ac05'
expected_formal_image_id='sha256:ab6d8f1816a40750a98bdcb18e5a7bd419869c43825a66631acc7f718e6f469b'
base_image='open-webui:v011-hotfix-e3a9c97dd059'
hotpatch_image='open-webui:v011-hotfix-c764e6ec2c01'
source_commit='c764e6ec2c01db17e2f6897e3201cacec59e2fd6'
target_revision='a11c0d3f0bd0'
artifact='/tmp/openwebui-v011-hotfix-c764e6ec2c01-context.tar.gz'
expected_artifact_sha256='74c99424bdb6d51099eb691ce64147e1725b0c9fdecd94da92ba384b97eca036'
deployment_root='/home/aiserver/staging/openwebui-pr7-eea11194ed-test'
context_dir="${deployment_root}/hotpatch-v011-c764e6ec2c01"
overlay="${deployment_root}/compose.webui-v011-hotfix-c764e6ec2c01.yaml"
backup_dir="${deployment_root}/backups/pre-hotpatch-c764e6ec2c01"
evidence_dir="${deployment_root}/evidence/v011-persisted-chat-c764e6ec2c01-20260729-131800"
...
docker build \
    ...
    --file "${context_dir}/Dockerfile.hotpatch-c764e6ec2c01" \
    --tag "${hotpatch_image}" \
    "${context_dir}"
...
[[ "${image_scope}" == 'v0.11-persisted-chat-restore' ]]
...
services:
  open-webui-pr7:
    image: open-webui:v011-hotfix-c764e6ec2c01
    environment:
