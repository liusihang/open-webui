...
db_user="webui_pr7"
database="webui_pr7"
expected_current_image_id="sha256:bdbd84db321857ee8a8cd29326dd000b4c51d77256c2805fe2e817b987ffa63a"
expected_formal_image_id="sha256:ab6d8f1816a40750a98bdcb18e5a7bd419869c43825a66631acc7f718e6f469b"
base_image="open-webui:v011-hotfix-0bb586c8699d"
hotpatch_image="open-webui:v011-hotfix-9643bd7ad189"
source_commit="9643bd7ad189ddc1e65fd6996d8b5c047e6e06e8"
target_revision="a11c0d3f0bd0"
artifact="/tmp/openwebui-v011-hotfix-9643bd7ad189-context.tar.gz"
expected_artifact_sha256="e4857ecdba9dad7b40424f6510878345ff6730eeb7156fdc06eb96a082a51127"
staged_overlay="/tmp/compose.webui-v011-hotfix-9643bd7ad189.yaml"
deployment_root="/home/aiserver/staging/openwebui-pr7-eea11194ed-test"
context_dir="${deployment_root}/hotpatch-v011-9643bd7ad189"
overlay="${deployment_root}/compose.webui-v011-hotfix-9643bd7ad189.yaml"
backup_dir="${deployment_root}/backups/pre-hotpatch-9643bd7ad189"
evidence_dir="${deployment_root}/evidence/v011-tool-call-dropdown-9643bd7ad189-20260729-142000"
...
docker build \
    ...
    --file "${context_dir}/Dockerfile.hotpatch-9643bd7ad189" \
    --tag "${hotpatch_image}" \
    "${context_dir}"
...
[[ "${image_scope}" == "v0.11-tool-call-detail-expansion" ]]
