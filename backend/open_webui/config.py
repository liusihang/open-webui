...
ENABLE_ONLYOFFICE_PREVIEW = os.getenv('ENABLE_ONLYOFFICE_PREVIEW', 'False').lower() == 'true'

ONLYOFFICE_DOCUMENT_SERVER_URL = os.getenv('ONLYOFFICE_DOCUMENT_SERVER_URL', '')

ONLYOFFICE_PUBLIC_BASE_URL = os.getenv('ONLYOFFICE_PUBLIC_BASE_URL', '')

ONLYOFFICE_JWT_SECRET = os.getenv('ONLYOFFICE_JWT_SECRET', '')

ONLYOFFICE_FILE_TOKEN_EXPIRES_IN = os.getenv('ONLYOFFICE_FILE_TOKEN_EXPIRES_IN', '5m')

ONLYOFFICE_EDIT_CALLBACK_TOKEN_EXPIRES_IN = os.getenv('ONLYOFFICE_EDIT_CALLBACK_TOKEN_EXPIRES_IN', '8h')
...
LAYER_GENERATION_MODEL = os.getenv('LAYER_GENERATION_MODEL', '').strip()
LAYER_GENERATION_PROMPT_ABSTRACT = os.getenv('LAYER_GENERATION_PROMPT_ABSTRACT', '')
LAYER_GENERATION_MAX_CHUNK_TOKENS = int(os.getenv('LAYER_GENERATION_MAX_CHUNK_TOKENS', '24000'))
LAYER_GENERATION_MIN_TAIL_TOKENS = int(os.getenv('LAYER_GENERATION_MIN_TAIL_TOKENS', '1000'))

OPEN_NOTEBOOK_BASE_URL = os.getenv('OPEN_NOTEBOOK_BASE_URL', '').rstrip('/')
OPEN_NOTEBOOK_API_PASSWORD = os.getenv('OPEN_NOTEBOOK_API_PASSWORD', '')
OPEN_NOTEBOOK_TIMEOUT_SECS = int(os.getenv('OPEN_NOTEBOOK_TIMEOUT_SECS', '30'))
OPEN_NOTEBOOK_TRANSFORMATION_ABSTRACT = os.getenv('OPEN_NOTEBOOK_TRANSFORMATION_ABSTRACT', '')
...
PADDLEOCR_VL_MODEL = os.getenv('PADDLEOCR_VL_MODEL', 'PaddleOCR-VL-1.6')
...
PADDLEOCR_VL_REQUEST_TIMEOUT = int(os.getenv('PADDLEOCR_VL_REQUEST_TIMEOUT', '30'))

PADDLEOCR_VL_DOWNLOAD_TIMEOUT = int(os.getenv('PADDLEOCR_VL_DOWNLOAD_TIMEOUT', '60'))

PADDLEOCR_VL_POLL_TIMEOUT = int(os.getenv('PADDLEOCR_VL_POLL_TIMEOUT', '300'))

PADDLEOCR_VL_POLL_INTERVAL = float(os.getenv('PADDLEOCR_VL_POLL_INTERVAL', '2'))
...
NATIVE_ATTACHED_KNOWLEDGE_BYPASS_LEGACY_FILE_RETRIEVAL = (
    os.getenv('NATIVE_ATTACHED_KNOWLEDGE_BYPASS_LEGACY_FILE_RETRIEVAL', 'False').lower() == 'true'
)
...
DEFAULT_CONFIG = {
    ...
    'onlyoffice.enable_preview': ENABLE_ONLYOFFICE_PREVIEW,
    'onlyoffice.document_server_url': ONLYOFFICE_DOCUMENT_SERVER_URL,
    'onlyoffice.public_base_url': ONLYOFFICE_PUBLIC_BASE_URL,
    'onlyoffice.jwt_secret': ONLYOFFICE_JWT_SECRET,
    'onlyoffice.file_token_expires_in': ONLYOFFICE_FILE_TOKEN_EXPIRES_IN,
    'onlyoffice.edit_callback_token_expires_in': ONLYOFFICE_EDIT_CALLBACK_TOKEN_EXPIRES_IN,
    'onlyoffice.callback_allowed_hosts': ONLYOFFICE_CALLBACK_ALLOWED_HOSTS,
    ...
    'layered_knowledge.internal.model': LAYER_GENERATION_MODEL,
    'layered_knowledge.internal.prompt_abstract': LAYER_GENERATION_PROMPT_ABSTRACT,
    'layered_knowledge.internal.max_chunk_tokens': LAYER_GENERATION_MAX_CHUNK_TOKENS,
    'layered_knowledge.internal.min_tail_tokens': LAYER_GENERATION_MIN_TAIL_TOKENS,
    'layered_knowledge.open_notebook.base_url': OPEN_NOTEBOOK_BASE_URL,
    'layered_knowledge.open_notebook.api_password': OPEN_NOTEBOOK_API_PASSWORD,
    'layered_knowledge.open_notebook.timeout_secs': OPEN_NOTEBOOK_TIMEOUT_SECS,
    'layered_knowledge.open_notebook.transformations.abstract': OPEN_NOTEBOOK_TRANSFORMATION_ABSTRACT,
    'layered_knowledge.open_notebook.transformations.key_findings': OPEN_NOTEBOOK_TRANSFORMATION_KEY_FINDINGS,
    'layered_knowledge.open_notebook.transformations.key_data': OPEN_NOTEBOOK_TRANSFORMATION_KEY_DATA,
    'layered_knowledge.native_attached_knowledge_bypass_legacy_file_retrieval': NATIVE_ATTACHED_KNOWLEDGE_BYPASS_LEGACY_FILE_RETRIEVAL,
    ...
    'rag.paddleocr_vl_model': PADDLEOCR_VL_MODEL,
    'rag.paddleocr_vl_optional_payload': PADDLEOCR_VL_OPTIONAL_PAYLOAD,
    'rag.paddleocr_vl_request_timeout': PADDLEOCR_VL_REQUEST_TIMEOUT,
    'rag.paddleocr_vl_download_timeout': PADDLEOCR_VL_DOWNLOAD_TIMEOUT,
    'rag.paddleocr_vl_poll_timeout': PADDLEOCR_VL_POLL_TIMEOUT,
    'rag.paddleocr_vl_poll_interval': PADDLEOCR_VL_POLL_INTERVAL,
    'rag.paddleocr_vl_allowed_remote_origins': PADDLEOCR_VL_ALLOWED_REMOTE_ORIGINS,
    'rag.extract_document_image_assets': RAG_EXTRACT_DOCUMENT_IMAGE_ASSETS,
    'rag.bypass_embedding_and_retrieval': BYPASS_EMBEDDING_AND_RETRIEVAL,
    'rag.enable_multimodal_knowledge_evidence': ENABLE_MULTIMODAL_KNOWLEDGE_EVIDENCE,
    'rag.top_k': RAG_TOP_K,
