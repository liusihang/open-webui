...
class FileMeta(BaseModel):
    ...
    size: int | None = None
    open_notebook_source_id: str | None = None
    open_notebook_source_ids: list[str] | None = None
    open_notebook_sync_status: str | None = None
    open_notebook_last_synced_at: int | None = None
    open_notebook_is_large_file: bool | None = None
    open_notebook_part_count: int | None = None
