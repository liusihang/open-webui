...
async def lifespan(app: FastAPI):
    ...
    if app.state.redis is not None:
        ...
        try:
            marker = app.state.redis.get("tool_routing:manifest_version")
            if inspect.isawaitable(marker):
                marker = await marker
            app.state.TOOL_ROUTING_MANIFEST_VERSION = int(marker or 0)
        except Exception as e:
            log.debug(f"Failed to initialize tool routing marker from Redis: {e}")
...
app.state.TOOL_ROUTING_MANIFEST_VERSION = 0
app.state.TOOL_ROUTING_LAST_SYNC_VERSION = 0
app.state.TOOL_ROUTING_MANIFEST_CACHE = {}
...
app.state.config.TOOL_ROUTING_ENABLE = TOOL_ROUTING_ENABLE
app.state.config.TOOL_ROUTING_MODE = TOOL_ROUTING_MODE
app.state.config.TOOL_ROUTING_SEMANTIC_TOP_N = TOOL_ROUTING_SEMANTIC_TOP_N
app.state.config.TOOL_ROUTING_FINAL_TOP_K = TOOL_ROUTING_FINAL_TOP_K
app.state.config.TOOL_ROUTING_MIN_CONFIDENCE = TOOL_ROUTING_MIN_CONFIDENCE
app.state.config.TOOL_ROUTING_LEXICAL_WEIGHT = TOOL_ROUTING_LEXICAL_WEIGHT
app.state.config.TOOL_ROUTING_RULE_WEIGHT = TOOL_ROUTING_RULE_WEIGHT
app.state.config.TOOL_ROUTING_MAX_INJECTED_TOOLS = TOOL_ROUTING_MAX_INJECTED_TOOLS
app.state.config.TOOL_ROUTING_MAX_SCHEMA_CHARS = TOOL_ROUTING_MAX_SCHEMA_CHARS
app.state.config.TOOL_ROUTING_BM25_WEIGHT = TOOL_ROUTING_BM25_WEIGHT
app.state.config.TOOL_ROUTING_INTENT_QUERY_ENABLE = TOOL_ROUTING_INTENT_QUERY_ENABLE
app.state.config.TOOL_ROUTING_INTENT_MAX_CLAUSES = TOOL_ROUTING_INTENT_MAX_CLAUSES
app.state.config.TOOL_ROUTING_INTENT_MAX_CHARS = TOOL_ROUTING_INTENT_MAX_CHARS
app.state.config.TOOL_ROUTING_CHAT_FLOOR_ENABLE = TOOL_ROUTING_CHAT_FLOOR_ENABLE
app.state.config.TOOL_ROUTING_CHAT_FLOOR_MIN_KEEP = TOOL_ROUTING_CHAT_FLOOR_MIN_KEEP
app.state.config.TOOL_ROUTING_EXPAND_ON_UNKNOWN = TOOL_ROUTING_EXPAND_ON_UNKNOWN
app.state.config.TOOL_ROUTING_MAX_EXPANSION_ROUNDS = TOOL_ROUTING_MAX_EXPANSION_ROUNDS
app.state.config.TOOL_ROUTING_KEYWORD_FALLBACK_ENABLE = (
    TOOL_ROUTING_KEYWORD_FALLBACK_ENABLE
)
app.state.config.TOOL_ROUTING_KEYWORD_FALLBACK_MODE_PATTERNS = (
    TOOL_ROUTING_KEYWORD_FALLBACK_MODE_PATTERNS
)
