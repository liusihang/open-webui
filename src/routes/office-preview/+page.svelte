...
<div
	class="h-screen max-h-[100dvh] flex flex-col bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-100"
>
	<header
	...
	<main class="flex-1 min-h-0 p-2 sm:p-3">
		{#if hasValidSource}
			<div
				class="w-full h-full rounded-lg border border-gray-100 dark:border-gray-800 overflow-hidden"
			>
				<OnlyOfficeViewer
					{fileId}
					{terminalServerId}
		...
		{:else}
			<div
				class="h-full w-full flex items-center justify-center text-sm text-gray-500 dark:text-gray-400"
			>
