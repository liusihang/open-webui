<script>
	...
	const allSettings = [
		...
		},
		{
			id: 'deep-research',
			title: 'Deep Research',
			route: '/admin/settings/deep-research',
			keywords: [
				'deep research',
				'deerflow',
				'langgraph',
				...
				<div class=" self-center mr-2">
					...
					{:else if tab.id === 'deep-research'}
						...
						>
							<path
								fill-rule="evenodd"
								d="M4.5 3A2.25 2.25 0 0 0 2.25 5.25v13.5A2.25 2.25 0 0 0 4.5 21h13.5a.75.75 0 0 0 .75-.75V7.5a.75.75 0 0 0-.22-.53l-3-3A.75.75 0 0 0 15 3H4.5Zm4.75 4.5a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75Zm0 3.75a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75Zm0 3.75a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H10a.75.75 0 0 1-.75-.75Z"
								clip-rule="evenodd"
							/>
						</svg>
