...
- [ ] Port changes semantically and add deployment compatibility/rollback tests.
- [ ] Run focused and full runtime/backend/frontend/build verification.
- [ ] Commit the corrected source and exact deployment assets.
- [ ] Rebuild WebUI/runtime images from the corrected commit.
