...
STAGING_ROOT=/home/aiserver/staging/openwebui-global-system-prompt-20d4dddcc130
SOURCE_DIR="$STAGING_ROOT/src"
LOG_PATH="$STAGING_ROOT/runtime-build.log"
STATUS_PATH="$STAGING_ROOT/runtime-build.status"
IMAGE_TAG=open-webui-pr7-agentscope-runtime:20d4dddcc130-phase-validation
