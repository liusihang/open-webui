...
STAGING_ROOT=/home/aiserver/staging/openwebui-agent-runtime-ed6b280f60d2
SOURCE_DIR="$STAGING_ROOT/src"
LOG_PATH="$STAGING_ROOT/runtime-build.log"
STATUS_PATH="$STAGING_ROOT/runtime-build.status"
IMAGE_TAG=open-webui-pr7-agentscope-runtime:ed6b280f60d2-response-envelopes
...
docker build \
  --progress=plain \
  --file "$STAGING_ROOT/Dockerfile.runtime-overlay-ed6b280f60d2" \
