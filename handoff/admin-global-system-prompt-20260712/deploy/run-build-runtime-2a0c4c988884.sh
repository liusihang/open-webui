...
STAGING_ROOT=/home/aiserver/staging/openwebui-agent-followup-2a0c4c988884
SOURCE_DIR="$STAGING_ROOT/src"
LOG_PATH="$STAGING_ROOT/runtime-build.log"
STATUS_PATH="$STAGING_ROOT/runtime-build.status"
IMAGE_TAG=open-webui-pr7-agentscope-runtime:2a0c4c988884-final-privacy-cancel
...
docker build \
  --progress=plain \
  --file "$STAGING_ROOT/Dockerfile.runtime-overlay-2a0c4c988884" \
