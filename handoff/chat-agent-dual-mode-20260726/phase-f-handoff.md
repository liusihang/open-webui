...
- [x] F6 Review remediation: property-presence decoding, per-mode draft/controller isolation, guarded async responses, private detail rendering, catalog accessibility, and behavioral regressions verified.
